  ...
  <div class="container">
    ...
    <div class="cover">
      ...
      <div class="back">
        ...
        <div class="text">
          <span class="text-1">Register for better voting experience!</span>
          <span class="text-2">Let's Vote</span>
        </div>
      </div>
    </div>
    <div class="forms">
        <div class="form-content">
          ...
          <form action="#">
            <div class="input-boxes">
              ...
              <div class="text sign-up-text">Login into your existing account - <label for="flip">Login now</label></div>
            </div>
        </form>
      </div>
      ...
      <form action="api/login.php" method="POST">
          <div class="input-boxes">
            ...
            <div class="text sign-up-text">Don't have an account? <a href="./routes/register.php">Register now</a>
            <br><br>
